...
function pano2vrSkin(player,base) {
	...
	player.addVariable('volume_on', 2, true);
	...
	this.addSkin=function() {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		hs='data:image/svg+xml;base64,'+
		...
		el=me._tourtitle_m=document.createElement('div');
		els=me._tourtitle_m__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="TourTitle_m";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="Dallas Sponsor<br\/>Tour";
		el.appendChild(els);
		me._tourtitle_m.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._tourtitle_m.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getVariableValue('mobilemenu') == true))
			)
			...
			if (me._tourtitle_m.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._tourtitle_m.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._tourtitle_m.style[domTransition]='';
				if (me._tourtitle_m.ggCurrentLogicStateVisible == 0) {
					me._tourtitle_m.style.visibility="hidden";
					me._tourtitle_m.ggVisible=false;
				}
				else {
					me._tourtitle_m.style.visibility=(Number(me._tourtitle_m.style.opacity)>0||!me._tourtitle_m.style.opacity)?'inherit':'hidden';
					me._tourtitle_m.ggVisible=true;
				}
			}
		}
		me._tourtitle_m.logicBlock_text = function() {
			...
			if (me._tourtitle_m.ggCurrentLogicStateText != newLogicStateText) {
				me._tourtitle_m.ggCurrentLogicStateText = newLogicStateText;
				me._tourtitle_m.style[domTransition]='';
				if (me._tourtitle_m.ggCurrentLogicStateText == 0) {
					me._tourtitle_m.ggText="Dallas Sponsor\nTour";
					me._tourtitle_m__text.innerHTML=me._tourtitle_m.ggText;
					if (me._tourtitle_m.ggUpdateText) {
					me._tourtitle_m.ggUpdateText=function() {
						var hs="Dallas Sponsor\nTour";
						if (hs!=this.ggText) {
							this.ggText=hs;
							this.ggTextDiv.innerHTML=hs;
							if (this.ggUpdatePosition) this.ggUpdatePosition();
						...
						if (me._tourtitle_m.ggUpdatePosition) me._tourtitle_m.ggUpdatePosition();
					}
				}
				else {
					me._tourtitle_m.ggText="Dallas Sponsor\nTour";
		...
		me._tourtitle_m.onclick=function (e) {
			player.setVariableValue('mobile_tour_menu', true);
		}
		me._tourtitle_m.ggUpdatePosition=function (useTransition) {
		}
		el=me._chevdown_m=document.createElement('div');
		els=me._chevdown_m__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'MwLjE4Nyw0OC45MDcgMCw3OS4wOTMgMTI4LDIwNy4wOTMgMjU2LDc5LjA5MyAgICIgZGF0YS1vbGRfY29sb3I9IiMwMDAwMDAiIGZpbGw9IiNmZmZmZmYiIGRhdGEtb3JpZ2luYWw9IiMwMDAwMDAiIGNsYXNzPSJhY3RpdmUtcGF0aCIgZmlsbC1vcGFjaXR5PSIxIi8+CiAgIDwvZz4KICA8L2c+CiA8L2c+Cjwvc3ZnPgo=';
		me._chevdown_m__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._chevdown_m.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._chevdown_m.ggUpdatePosition=function (useTransition) {
		}
		me._tourtitle_m.appendChild(me._chevdown_m);
		me._mobile.appendChild(me._tourtitle_m);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'UuMzM1MSw5LjE2YTIuMDM0NCwyLjAzNDQsMCwwLDEsLjU0OTItMS40NjQsMS45NTY2LDEuOTU2NiwwLDAsMSwyLjc3MTMsMFptLTMuMDU5LDUuNDM3OGgzLjM5ODVWMjcuMTJIMTUuNTk2NloiLz4KIDwvZz4KPC9zdmc+Cg==';
		...
		ela.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'kuMTZhMi4wMzQ0LDIuMDM0NCwwLDAsMSwuNTQ5Mi0xLjQ2NCwxLjk1NjYsMS45NTY2LDAsMCwxLDIuNzcxMywwWm0tMy4wNTksNS40Mzc4aDMuMzk4NVYyNy4xMkgxNS41OTY2WiIvPgogPC9nPgo8L3N2Zz4K';
		...
		el=me._m_menu_shadow=document.createElement('div');
		el.ggId="m_menu shadow";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		el.className="ggskin ggskin_rectangle ";
		el.ggType='rectangle';
		...
		hs+='width : 100%;';
		hs+='pointer-events:auto;';
		hs+='background: rgb(0,0,0); background: linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 100%);';
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._m_menu_shadow.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._m_menu_shadow.logicBlock_position = function() {
			...
			if (me._m_menu_shadow.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._m_menu_shadow.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._m_menu_shadow.style[domTransition]='left 1000ms ease 0ms, top 1000ms ease 0ms';
				if (me._m_menu_shadow.ggCurrentLogicStatePosition == 0) {
					me._m_menu_shadow.style.left='0%';
					me._m_menu_shadow.style.top='0px';
				}
				else {
					me._m_menu_shadow.style.left='-101.333%';
					me._m_menu_shadow.style.top='0px';
				}
			}
		}
		me._m_menu_shadow.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getVariableValue('mobilemenu') == true)) || 
				((player.getVariableValue('node_vis_m') == true))
			...
			if (me._m_menu_shadow.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._m_menu_shadow.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._m_menu_shadow.style[domTransition]='left 1000ms ease 0ms, top 1000ms ease 0ms';
				if (me._m_menu_shadow.ggCurrentLogicStateVisible == 0) {
					me._m_menu_shadow.style.visibility=(Number(me._m_menu_shadow.style.opacity)>0||!me._m_menu_shadow.style.opacity)?'inherit':'hidden';
					me._m_menu_shadow.ggVisible=true;
				}
				else {
					me._m_menu_shadow.style.visibility="hidden";
					me._m_menu_shadow.ggVisible=false;
				}
			}
		}
		me._m_menu_shadow.onclick=function (e) {
			player.setVariableValue('mobilemenu', false);
			player.setVariableValue('node_vis_m', false);
		}
		me._m_menu_shadow.ggUpdatePosition=function (useTransition) {
		}
		me._mobile.appendChild(me._m_menu_shadow);
		el=me._menu_button=document.createElement('div');
		els=me._menu_button__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'LDIyLjc1LDE4Ljg3NXoiIGNsYXNzPSJhY3RpdmUtcGF0aCIgZmlsbC1vcGFjaXR5PSIxIi8+CiAgPC9nPgogPC9nPgo8L3N2Zz4K';
		...
		me._menu_button.onclick=function (e) {
			player.setVariableValue('mobilemenu', true);
		}
		me._menu_button.ggUpdatePosition=function (useTransition) {
		}
		me._mobile.appendChild(me._menu_button);
		el=me._mobile_menu_1=document.createElement('div');
		el.ggId="mobile menu 1";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		el.ggType='rectangle';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._mobile_menu_1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._mobile_menu_1.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('mobilemenu') == true))
			)
			...
			if (me._mobile_menu_1.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._mobile_menu_1.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._mobile_menu_1.style[domTransition]='left 500ms ease 0ms, top 500ms ease 0ms, width 0s, height 0s';
				if (me._mobile_menu_1.ggCurrentLogicStatePosition == 0) {
					me._mobile_menu_1.style.left='0px';
					me._mobile_menu_1.style.top='0px';
				}
				else {
					me._mobile_menu_1.style.left='-221px';
					me._mobile_menu_1.style.top='0px';
				}
			}
		}
		me._mobile_menu_1.logicBlock_size = function() {
			...
			if (me._mobile_menu_1.ggCurrentLogicStateSize != newLogicStateSize) {
				me._mobile_menu_1.ggCurrentLogicStateSize = newLogicStateSize;
				me._mobile_menu_1.style[domTransition]='left 500ms ease 0ms, top 500ms ease 0ms, width 0s, height 0s';
				if (me._mobile_menu_1.ggCurrentLogicStateSize == 0) {
					me._mobile_menu_1.style.width='220px';
					me._mobile_menu_1.style.height='100%';
					skin.updateSize(me._mobile_menu_1);
				}
				else {
					me._mobile_menu_1.style.width='200px';
					me._mobile_menu_1.style.height='100%';
					skin.updateSize(me._mobile_menu_1);
				}
			}
		}
		me._mobile_menu_1.ggUpdatePosition=function (useTransition) {
		}
		el=me._access_m1=document.createElement('div');
		el.ggId="access_m1";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._access_m1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._access_m1.onclick=function (e) {
			player.openUrl(".\/accessible\/","_blank");
		}
		me._access_m1.onmouseout=function (e) {
			me.elementMouseDown['access_m1']=false;
			me._acc_box.logicBlock_backgroundcolor();
		}
		me._access_m1.onmousedown=function (e) {
			me.elementMouseDown['access_m1']=true;
			me._acc_box.logicBlock_backgroundcolor();
		}
		me._access_m1.onmouseup=function (e) {
			me.elementMouseDown['access_m1']=false;
			me._acc_box.logicBlock_backgroundcolor();
		}
		me._access_m1.ontouchend=function (e) {
			me.elementMouseDown['access_m1']=false;
			me._acc_box.logicBlock_backgroundcolor();
		}
		me._access_m1.ggUpdatePosition=function (useTransition) {
		}
		el=me._acc_box=document.createElement('div');
		el.ggId="acc_box";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._acc_box.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._acc_box.logicBlock_backgroundcolor = function() {
			...
			if (me._acc_box.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._acc_box.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._acc_box.style[domTransition]='background-color 0s';
				if (me._acc_box.ggCurrentLogicStateBackgroundColor == 0) {
					me._acc_box.style.backgroundColor="rgba(238,38,82,1)";
				}
				else {
					me._acc_box.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		me._acc_box.ggUpdatePosition=function (useTransition) {
		}
		me._access_m1.appendChild(me._acc_box);
		el=me._accesstxt1=document.createElement('div');
		els=me._accesstxt1__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="accesstxt1";
		el.ggDy=2;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="Accessible Version";
		el.appendChild(els);
		me._accesstxt1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._accesstxt1.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._access_m1.appendChild(me._accesstxt1);
		el=me._accessicon1=document.createElement('div');
		els=me._accessicon1__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			'LW9wYWNpdHk9IjAiLz4KIDwvZz4KPC9zdmc+Cg==';
		me._accessicon1__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._accessicon1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._accessicon1.onclick=function (e) {
			if (
				(
					((player.getIsMobile() == true))
				)
  ...
  navigator.share({
      title: 'Troy Tour',
      text: 'Check out a virtual tour of Troy NY',
      url: 'https://sitetour360.com/covance/#$(unode)',
  })
    ...
    .catch((error) => console.log('Error sharing', error));
		...
		me._accessicon1.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._access_m1.appendChild(me._accessicon1);
		me._mobile_menu_1.appendChild(me._access_m1);
		el=me._share_m1=document.createElement('div');
		el.ggId="share_m1";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._share_m1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._share_m1.onclick=function (e) {
			if (
				(
					((player.getIsMobile() == true))
				)
				...
				if (navigator.share) {
  navigator.share({
      title: 'Covance Dallas Sponsor Tour',
      text: 'Check out this virtual experience!',
      url: 'https://sitetour360.com/covance-dallas-sponsor-tour/',
  })
    .then(() => console.log('Successful share'))
    .catch((error) => console.log('Error sharing', error));
}
		...
		me._share_m1.onmouseout=function (e) {
			me.elementMouseDown['share_m1']=false;
			me._sharebox_m.logicBlock_backgroundcolor();
		}
		me._share_m1.onmousedown=function (e) {
			me.elementMouseDown['share_m1']=true;
			me._sharebox_m.logicBlock_backgroundcolor();
		}
		me._share_m1.onmouseup=function (e) {
			me.elementMouseDown['share_m1']=false;
			me._sharebox_m.logicBlock_backgroundcolor();
		}
		me._share_m1.ontouchend=function (e) {
			me.elementMouseDown['share_m1']=false;
			me._sharebox_m.logicBlock_backgroundcolor();
		}
		me._share_m1.ggUpdatePosition=function (useTransition) {
		}
		el=me._sharebox_m=document.createElement('div');
		el.ggId="sharebox_m";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._sharebox_m.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._sharebox_m.logicBlock_backgroundcolor = function() {
			var newLogicStateBackgroundColor;
			if (
				((me.elementMouseDown['share_m1'] == true))
			)
			...
			if (me._sharebox_m.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me._sharebox_m.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me._sharebox_m.style[domTransition]='background-color 0s';
				if (me._sharebox_m.ggCurrentLogicStateBackgroundColor == 0) {
					me._sharebox_m.style.backgroundColor="rgba(238,38,82,1)";
				}
				else {
					me._sharebox_m.style.backgroundColor="rgba(255,255,255,0)";
				}
			}
		}
		me._sharebox_m.ggUpdatePosition=function (useTransition) {
		}
		me._share_m1.appendChild(me._sharebox_m);
		el=me._sharetxt1=document.createElement('div');
		els=me._sharetxt1__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="sharetxt1";
		el.ggDy=2;
		...
		els.innerHTML="Share";
		el.appendChild(els);
		me._sharetxt1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._sharetxt1.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._share_m1.appendChild(me._sharetxt1);
		el=me._shareicon1=document.createElement('div');
		els=me._shareicon1__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'Q4NC0uMjYzNi0uMTI2MS0uNTIxOC0uMTktLjc4MjZaIi8+Cjwvc3ZnPgo=';
		me._shareicon1__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._shareicon1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._shareicon1.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._share_m1.appendChild(me._shareicon1);
		me._mobile_menu_1.appendChild(me._share_m1);
		me._mobile.appendChild(me._mobile_menu_1);
		...
		el.ggType='rectangle';
		hs ='';
		hs+='background : rgba(10,25,50,0.745098);';
		hs+='border : 0px solid #000000;';
		hs+='cursor : default;';
		hs+='height : 100%;';
		hs+='position : absolute;';
		...
		el=me._shadow=document.createElement('div');
		el.ggId="shadow";
		el.ggDx=1;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		hs+='background : rgba(0,0,0,0.25098);';
		hs+='border : 0px solid #000000;';
		hs+='cursor : default;';
		hs+='height : 275px;';
		hs+='left : -10000px;';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._shadow.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._shadow.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._mobile_info_menu.appendChild(me._shadow);
		...
		el=me._read_more=document.createElement('div');
		els=me._read_more__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="read more";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		hs+='white-space: nowrap;';
		hs+='padding: 10px 6px 10px 6px;';
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="Read More";
		el.appendChild(els);
		me._read_more.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._read_more.onclick=function (e) {
			player.setVariableValue('readmore_mobile', true);
		}
		me._read_more.ggUpdatePosition=function (useTransition) {
		}
		me._mobile_info_txt.appendChild(me._read_more);
		me._mobile_info_menu.appendChild(me._mobile_info_txt);
		el=me._txt_exp_bg=document.createElement('div');
		el.ggId="txt_exp_bg";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		el.className="ggskin ggskin_rectangle ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._txt_exp_bg.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._txt_exp_bg.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
			...
			if (me._txt_exp_bg.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._txt_exp_bg.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._txt_exp_bg.style[domTransition]='';
				if (me._txt_exp_bg.ggCurrentLogicStateVisible == 0) {
					me._txt_exp_bg.style.visibility=(Number(me._txt_exp_bg.style.opacity)>0||!me._txt_exp_bg.style.opacity)?'inherit':'hidden';
					me._txt_exp_bg.ggVisible=true;
				}
				else {
					me._txt_exp_bg.style.visibility="hidden";
					me._txt_exp_bg.ggVisible=false;
				}
			}
		}
		me._txt_exp_bg.ggUpdatePosition=function (useTransition) {
		}
		me._mobile_info_menu.appendChild(me._txt_exp_bg);
		el=me._mobinfotxt_expanded=document.createElement('div');
		els=me._mobinfotxt_expanded__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="mobinfotxt_expanded";
		el.ggDx=-1;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=false;
		el.className="ggskin ggskin_text ";
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		me._mobinfotxt_expanded.ggUpdateText=function() {
		...
		me._mobinfotxt_expanded.ggUpdateText();
		player.addListener('changenode', function() {
			me._mobinfotxt_expanded.ggUpdateText();
		});
		el.appendChild(els);
		me._mobinfotxt_expanded.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._mobinfotxt_expanded.logicBlock_size = function() {
			var newLogicStateSize;
			if (
			...
			if (me._mobinfotxt_expanded.ggCurrentLogicStateSize != newLogicStateSize) {
				me._mobinfotxt_expanded.ggCurrentLogicStateSize = newLogicStateSize;
				me._mobinfotxt_expanded.style[domTransition]='width 0s, height 0s';
				me._mobinfotxt_expanded__text.style[domTransition]='width 0s, height 0s';
				if (me._mobinfotxt_expanded.ggCurrentLogicStateSize == 0) {
					me._mobinfotxt_expanded.style.width='89.87%';
					me._mobinfotxt_expanded__text.style.height='345px';
					skin.updateSize(me._mobinfotxt_expanded);
				}
				else {
					me._mobinfotxt_expanded.style.width='89.8667%';
					me._mobinfotxt_expanded__text.style.height='400px';
					skin.updateSize(me._mobinfotxt_expanded);
				}
			}
		}
		me._mobinfotxt_expanded.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getVariableValue('readmore_mobile') == true))
			)
			...
			if (me._mobinfotxt_expanded.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._mobinfotxt_expanded.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._mobinfotxt_expanded.style[domTransition]='width 0s, height 0s';
				if (me._mobinfotxt_expanded.ggCurrentLogicStateVisible == 0) {
					me._mobinfotxt_expanded.style.visibility=(Number(me._mobinfotxt_expanded.style.opacity)>0||!me._mobinfotxt_expanded.style.opacity)?'inherit':'hidden';
					me._mobinfotxt_expanded.ggVisible=true;
				}
				else {
					me._mobinfotxt_expanded.style.visibility="hidden";
					me._mobinfotxt_expanded.ggVisible=false;
				}
			}
		}
		me._mobinfotxt_expanded.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._mobile_info_menu.appendChild(me._mobinfotxt_expanded);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'0uMDQ4NC0uMjYzNi0uMTI2MS0uNTIxOC0uMTktLjc4MjZaIiBmaWxsLW9wYWNpdHk9IjEiLz4KPC9zdmc+Cg==';
		...
		ela.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			'0uMDQ4NC0uMjYzNi0uMTI2MS0uNTIxOC0uMTktLjc4MjZaIiBmaWxsLW9wYWNpdHk9IjEiLz4KPC9zdmc+Cg==';
  ...
  navigator.share({
    ...
    .catch((error) => console.log('Error sharing', error));
		...
		hs='data:image/svg+xml;base64,'+
			''+
			'';
		...
		ela.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'gyMzgsMCwwLDAsMjIuNTAzNSwxNy41Wk0xOS43MjUzLDcuNzIyM3YyLjMzMzZhNy43NjQ4LDcuNzY0OCwwLDAsMSwwLDE0Ljg4ODJ2Mi4zMzM2YTEwLjAzNTcsMTAuMDM1NywwLDAsMCwwLTE5LjU1NTRaIiBmaWxsLW9wYWNpdHk9IjEiLz4KIDwvZz4KPC9zdmc+Cg==';
		...
		ela.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			''+
		...
		hs='data:image/svg+xml;base64,'+
			...
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		ela.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			...
			''+
			...
			''+
		...
		me._close_info_m.onclick=function (e) {
			...
			if (
				...
				player.setVariableValue('readmore_mobile', false);
			}
			if (
				(
					((player.getVariableValue('gallery_vis_m') == true))
				)
			) {
				player.setVariableValue('gallery_vis_m', false);
			}
			player.setVariableValue('gallery_img', Number("0"));
			if (
				(
					((player.getVariableValue('video_m') == true))
				)
			) {
				player.setVariableValue('video_m', false);
			}
		}
		...
		el=me._covance_box=document.createElement('div');
		el.ggId="covance box";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._covance_box.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._covance_box.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('mobilemenu') == true))
			)
			...
			if (me._covance_box.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._covance_box.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._covance_box.style[domTransition]='right 1000ms ease 0ms, bottom 1000ms ease 0ms';
				if (me._covance_box.ggCurrentLogicStatePosition == 0) {
					me._covance_box.style.right='-35px';
					me._covance_box.style.bottom='0px';
				}
				else {
					me._covance_box.style.right='-330px';
					me._covance_box.style.bottom='0px';
				}
			}
		}
		me._covance_box.ggUpdatePosition=function (useTransition) {
		}
		...
		me._covance_box.appendChild(me._cov_logo);
		me._mobile.appendChild(me._covance_box);
		el=me._cce_box=document.createElement('div');
		el.ggId="cce_box";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._cce_box.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._cce_box.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('mobilemenu') == true))
			)
			...
			if (me._cce_box.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._cce_box.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._cce_box.style[domTransition]='left 750ms ease 0ms, top 750ms ease 0ms, width 0s, height 0s';
				if (me._cce_box.ggCurrentLogicStatePosition == 0) {
					me._cce_box.style.left='-50px';
					me._cce_box.style.top='0px';
				}
				else {
					me._cce_box.style.left='-400px';
					me._cce_box.style.top='0px';
				}
			}
		}
		me._cce_box.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getOS() == 4))
			)
			...
			if (me._cce_box.ggCurrentLogicStateSize != newLogicStateSize) {
				me._cce_box.ggCurrentLogicStateSize = newLogicStateSize;
				me._cce_box.style[domTransition]='left 750ms ease 0ms, top 750ms ease 0ms, width 0s, height 0s';
				if (me._cce_box.ggCurrentLogicStateSize == 0) {
					me._cce_box.style.width='360px';
					me._cce_box.style.height='60px';
					skin.updateSize(me._cce_box);
				}
				else {
					me._cce_box.style.width='330px';
					me._cce_box.style.height='60px';
					skin.updateSize(me._cce_box);
				}
			}
		}
		me._cce_box.ggUpdatePosition=function (useTransition) {
		}
		el=me._m_menuoff=document.createElement('div');
		els=me._m_menuoff__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'MwLjE4Nyw0OC45MDcgMCw3OS4wOTMgMTI4LDIwNy4wOTMgMjU2LDc5LjA5MyAgICIgZGF0YS1vbGRfY29sb3I9IiMwMDAwMDAiIGZpbGw9IiMyNTJlNDAiIGRhdGEtb3JpZ2luYWw9IiMwMDAwMDAiIGNsYXNzPSJhY3RpdmUtcGF0aCIgZmlsbC1vcGFjaXR5PSIwLjI1MDk4Ii8+CiAgIDwvZz4KICA8L2c+CiA8L2c+Cjwvc3ZnPgo=';
		me._m_menuoff__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._m_menuoff.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._m_menuoff.logicBlock_angle = function() {
			...
			if (me._m_menuoff.ggCurrentLogicStateAngle != newLogicStateAngle) {
				me._m_menuoff.ggCurrentLogicStateAngle = newLogicStateAngle;
				me._m_menuoff.style[domTransition]='' + cssPrefix + 'transform 750ms ease 0ms';
				if (me._m_menuoff.ggCurrentLogicStateAngle == 0) {
					me._m_menuoff.ggParameter.a = 90;
					me._m_menuoff.style[domTransform]=parameterToTransform(me._m_menuoff.ggParameter);
				}
				else {
					me._m_menuoff.ggParameter.a = 0;
					me._m_menuoff.style[domTransform]=parameterToTransform(me._m_menuoff.ggParameter);
				}
			}
		}
		me._m_menuoff.onclick=function (e) {
			player.setVariableValue('mobilemenu', false);
		}
		me._m_menuoff.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._cce_box.appendChild(me._m_menuoff);
		me._mobile.appendChild(me._cce_box);
		el=me._cce=document.createElement('div');
		els=me._cce__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="cce";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="FrontStreet Virtual Experience";
		el.appendChild(els);
		me._cce.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._cce.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('mobilemenu') == true))
			)
			...
			if (me._cce.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._cce.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._cce.style[domTransition]='left 750ms ease 0ms, top 750ms ease 0ms';
				if (me._cce.ggCurrentLogicStatePosition == 0) {
					me._cce.style.left='15px';
					me._cce.style.top='20px';
				}
				else {
					me._cce.style.left='-425px';
					me._cce.style.top='20px';
				}
			}
		}
		me._cce.ggUpdatePosition=function (useTransition) {
		}
		me._mobile.appendChild(me._cce);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'MsNTBaIiBmaWxsLW9wYWNpdHk9IjEiLz4KIDwvZz4KPC9zdmc+Cg==';
		me._close_menu__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		ela=me._close_menu__imga=document.createElement('img');
		ela.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'A2NDMsNTBaIi8+CiA8L2c+Cjwvc3ZnPgo=';
		me._close_menu__imga.setAttribute('src',hs);
		ela.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;;');
		ela['ondragstart']=function() { return false; };
		el.appendChild(ela);
		el.ggId="close menu";
		...
		me._close_menu.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getVariableValue('hs_info_open_m') == true)) || 
				((player.getVariableValue('node_vis_m') == true))
			)
			{
				newLogicStateVisible = 0;
		...
		me._close_menu.onclick=function (e) {
			player.setVariableValue('node_vis_m', false);
			player.setVariableValue('hs_info_open_m', false);
		}
		me._close_menu.onmouseout=function (e) {
			me._close_menu__imga.style.visibility='hidden';
		}
		me._close_menu.onmousedown=function (e) {
			me._close_menu__imga.style.visibility='inherit';
		}
		me._close_menu.onmouseup=function (e) {
			me._close_menu__imga.style.visibility='hidden';
		}
		me._close_menu.ggUpdatePosition=function (useTransition) {
		}
		me._mobile.appendChild(me._close_menu);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		hs='data:image/svg+xml;base64,'+
			'';
  ...
  .catch(err => {
	...
	function SkinCloner_node_cloner_m_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me.__div.setAttribute('style','position: absolute;width: 1920px; height: 175px; visibility: inherit; overflow: hidden;');
	...
	me._tourtitle_m.logicBlock_text();
	me._mobinfotxt_expanded.logicBlock_size();
	...
	me._tourtitle_m.logicBlock_visible();
	me._info_m.logicBlock_visible();
	me._info_ani_m.logicBlock_visible();
	me._m_menu_shadow.logicBlock_position();
	me._m_menu_shadow.logicBlock_visible();
	me._mobile_menu_1.logicBlock_position();
	me._mobile_info_menu.logicBlock_position();
	me._txt_exp_bg.logicBlock_visible();
	me._mobinfotxt_expanded.logicBlock_visible();
	...
	me._covance_box.logicBlock_position();
	me._cce_box.logicBlock_position();
	me._m_menuoff.logicBlock_angle();
	me._cce.logicBlock_position();
	...
	me._mobile_menu_1.logicBlock_size();
	me._cce_box.logicBlock_size();
	me._desktop.logicBlock_visible();
	player.addListener('sizechanged', function(args) { me._tourtitle_m.logicBlock_text();me._mobinfotxt_expanded.logicBlock_size();me._nodemenu_background.logicBlock_size(); });
	player.addListener('imagesready', function(args) { me._loading_splash.logicBlock_visible(); });
	player.addListener('changenode', function(args) { me._currentnode_m.logicBlock_visible();me._nextnode_m.logicBlock_visible();me._tourtitle_m.logicBlock_visible();me._info_m.logicBlock_visible();me._info_ani_m.logicBlock_visible();me._m_menu_shadow.logicBlock_position();me._m_menu_shadow.logicBlock_visible();me._mobile_menu_1.logicBlock_position();me._mobile_info_menu.logicBlock_position();me._txt_exp_bg.logicBlock_visible();me._mobinfotxt_expanded.logicBlock_visible();me._mute_m.logicBlock_visible();me._vol_m.logicBlock_visible();me._gyro_deactive.logicBlock_visible();me._gyro_active.logicBlock_visible();me._close_info_m.logicBlock_size();me._covance_box.logicBlock_position();me._cce_box.logicBlock_position();me._m_menuoff.logicBlock_angle();me._cce.logicBlock_position();me._nodemenu_background.logicBlock_position();me._close_menu.logicBlock_visible();me.__2d_overlay.logicBlock_visible();me._menu_close.logicBlock_alpha();me._menu_shadow.logicBlock_position();me._current_next_txt.logicBlock_position();me._next_node.logicBlock_visible();me._tourtitle.logicBlock_position();me._menu_background.logicBlock_position();me.__360animation_timer.logicBlock_visible();me._nextnode.logicBlock_visible();me._info_button.logicBlock_visible();me._mute_button.logicBlock_visible();me._pause_audio.logicBlock_visible();me._play_audio.logicBlock_visible();me._audio_info.logicBlock_position();me._buttonbar.logicBlock_size();me._buttonbar.logicBlock_alpha();me._audio_animation.logicBlock_visible();me._audio_animation.logicBlock_alpha();me._shareclose.logicBlock_visible();me._share_button.logicBlock_visible();me._sharebox.logicBlock_visible();me._link_copied.logicBlock_visible();me._start_overlay.logicBlock_visible();me._click_anywhere_to_begin.logicBlock_visible();me.__360animation.logicBlock_visible();me._text_360.logicBlock_visible();me._loading_splash.logicBlock_visible(); });
	player.addListener('configloaded', function(args) { me._mobile.logicBlock_visible();me._mobile_menu_1.logicBlock_size();me._cce_box.logicBlock_size();me._desktop.logicBlock_visible(); });
	...
	player.addListener('varchanged_mobilemenu', function(args) { me._currentnode_m.logicBlock_visible();me._nextnode_m.logicBlock_visible();me._tourtitle_m.logicBlock_visible();me._info_m.logicBlock_visible();me._m_menu_shadow.logicBlock_position();me._m_menu_shadow.logicBlock_visible();me._mobile_menu_1.logicBlock_position();me._covance_box.logicBlock_position();me._cce_box.logicBlock_position();me._m_menuoff.logicBlock_angle();me._cce.logicBlock_position(); });
	player.addListener('varchanged_node_vis_m', function(args) { me._m_menu_shadow.logicBlock_position();me._m_menu_shadow.logicBlock_visible();me._nodemenu_background.logicBlock_position();me._close_menu.logicBlock_visible(); });
	player.addListener('varchanged_mobile_info_menu', function(args) { me._mobile_info_menu.logicBlock_position(); });
	player.addListener('varchanged_hs_info_open_m', function(args) { me._close_menu.logicBlock_visible(); });
	...
	player.addListener('varchanged_readmore_mobile', function(args) { me._txt_exp_bg.logicBlock_visible();me._mobinfotxt_expanded.logicBlock_visible();me._close_info_m.logicBlock_size(); });
